...
//json.parse was used to retrieve all the object stored in the localstorage named "savedUsersList"
//if the localstorage is currently empty, a default value is given, which is empty.
export let users = JSON.parse(localStorage.getItem('savedUsersList')) || [];
